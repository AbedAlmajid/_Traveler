...
namespace DemoTraveler.Areas.Administrator.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoleId,RoleName,IsDeleted,IsActive,CreationDate,ModificationDate")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("RoleId,RoleName,IsDeleted,IsActive,CreationDate,ModificationDate")] Role role)
        {
            if (id != role.RoleId)
            {
                return NotFound();
