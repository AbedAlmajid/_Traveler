...
namespace DemoTraveler.Areas.AirCompany.Controllers
{
    ...
    public class TravelsController : Controller
    {
        ...
        // GET: AirCompany/Travels/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AirCompany/Travels/Create
        ...
        // POST: AirCompany/Travels/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AirCompany/Travels/Delete/5
        ...
        // POST: AirCompany/Travels/Delete/5
